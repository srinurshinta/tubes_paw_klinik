...
<div class="container-fluid">
	...
	<div class="page-header"><h3 align="center">Rekam Medis Pasien</h3></div>
	<form class="form-horizontal" method="post" action="">
	<div class="form-group">
		<label for="no_rm" class="control-label col-sm-3">Kode Pasien</label>
		<div class="col-sm-8">
			<?=$no_rm;?><input type="hidden" name="no_rm" value="<?=$no_rm?>" class="form-control" >
		</div>
	</div>
	...
	<div class="form-group">
		...
		<div class="col-sm-8">
			<?=$nama_pasien;?><input type="hidden" name="nama_pasien" value="<?=$nama_pasien?>" class="form-control">
		</div>
	</div>

  	<div class="form-group">
  		<label for="tgl_periksa" class="control-label col-sm-3">Tanggal Kunjungan</label>
  		<div class="col-sm-8">
  	...
  	<div class="form-group">
  		<label for="nama_obat" class="control-label col-sm-3">Obat</label>
  		<div class="col-sm-8">
