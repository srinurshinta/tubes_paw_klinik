...
<div class="container-fluid">
  ...
  <?php
    ...
    <div class="form-group">
      <label  class="control-label col-sm-3">No RM</label>
      <div class="col-sm-8">
        <input type="text" disabled="disabled" class="form-control" value="<?php echo $no_rm ?>" />
      </div>  
    </div>
    ...
    <div class="form-group">
      ...
      <div class="col-sm-8">
        <input type="text" disabled="disabled"  class="form-control" value="<?php echo $nama_pasien ?>" />
      </div>  
    </div>
    ...
    <label for="btn" class="control-label col-sm-3"></label>
      <div class="col-sm-8">
            <div class="col-sm-4">
            <input type="submit" id="submit" name="tambah_rm" class="btn btn-danger btn-block" value="Lanjut" />
            </div>
            <div class="col-sm-4">
  ...
  if($rekam_medis) {
    if( $tgl_periksa == "" || $nama_dokter == "" || $keluhan == "" || $diagnosa == "" || $penyakit == "" || $tindakan == "") {
      ...
      mysql_query("insert into tbl_rm(no_rm, nama_pasien, tgl_periksa, nama_dokter, keluhan, diagnosa, penyakit, tindakan) values('$no_rm', '$nama_pasien', '$tgl_periksa', '$nama_dokter', '$keluhan', '$diagnosa', '$penyakit', '$tindakan')") or die (mysql_error());
      ?>
      <script type="text/javascript">
