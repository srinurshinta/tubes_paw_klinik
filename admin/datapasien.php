...
<legend>Data Pasien - Klinik Utama Waluya </legend>
	<div class="row">
		<div class="col-md-6">
			...
			<a href="?page=pasien&action=tambah_pasien" class="btn btn-danger"><span class="glyphicon glyphicon-plus"></span> Tambah Baru</a>
			...
			<tbody>
				...
				?>
					...
					<tr>
						...
						<td align="center">
							<a href="?page=pasien&action=edit_pasien&no_rm=<?php echo $data['no_rm']; ?>" class="btn btn-danger btn-xs" ><span class="glyphicon glyphicon-pencil"></span></a>
