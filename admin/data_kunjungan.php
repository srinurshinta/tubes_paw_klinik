...
<legend>Data Kunjungan - Klinik Utama Waluya </legend>
	<div class="row">
		<div class="col-md-6">
			...
			<a href="?page=kunjungan&action=tambah_kunjungan" class="btn btn-danger"><span class="glyphicon glyphicon-plus"></span> Tambah Baru</a>
	...
	<div class="col-md-12 col-xs-12">
		<table class="table table-bordered table-striped table-hover">
				...
				<tr>
						...
						<td align="center">
							<a onclick="return confirm('Yakin ingin menghapus data ?')" href="?page=kunjungan&action=hapus_kunjungan&kodekunjung=<?php echo $data['kode_kunjung']; ?>" class="btn btn-danger btn-xs"><span class="glyphicon glyphicon-remove"></span></a>
						</td>
					</tr>
				<?php
				}
