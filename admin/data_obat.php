...
<legend>Data Obat - Klinik Utama Waluya </legend>
	<div class="row">
		<div class="col-md-6">
			...
			<a href="?page=obat&action=tambah_obat" class="btn btn-danger"><span class="glyphicon glyphicon-plus"></span> Tambah Baru</a>
		...
		<table class="table table-bordered table-striped table-hover">
				...
				?>
					...
					<tr>
						...
						<td align="center">
							<a href="?page=obat&action=edit_obat&kode_obat=<?php echo $data['kode_obat']; ?>" class="btn btn-danger btn-xs" ><span class="glyphicon glyphicon-pencil"></span></a>
							<a onclick="return confirm('Yakin ingin menghapus data ?')" href="?page=obat&action=hapus_obat&kodeobat=<?php echo $data['kode_obat']; ?>" class="btn btn-danger btn-xs" ><span class="glyphicon glyphicon-remove"></span></a>
						</td>
					</tr>
				<?php
					}
