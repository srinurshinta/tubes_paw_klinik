...
<legend>Data Rekam Medis - Klinik Utama Waluya </legend>
	...
	<a href="?page=rekam_medis&action=tambah_rm" class="btn btn-danger"><span class="glyphicon glyphicon-plus"></span> Tambah Baru</a>
	...
	<div class="col-md-12 col-xs-12">
		<table class="table table-bordered table-striped table-hover">
			...
			<tr>
					...
					<td align="center">
						<a href="?page=rekam_medis&action=edit_rm&kd_rm=<?php echo $data['kd_rm']; ?>" class="btn btn-danger btn-xs" ><span class="glyphicon glyphicon-pencil"></span></a>
						<a onclick="return confirm('Yakin ingin menghapus data ?')" href="?page=rekam_medis&action=hapus_rm&kdrm=<?php echo $data['kd_rm']; ?>" class="btn btn-danger btn-xs" ><span class="glyphicon glyphicon-remove"></span></a>
					</td>
				</tr>
			<?php
			}
